                ...
                <td colspan="4">
                    <table width="100%" border="0" class="dashbord-tables">
                        <tr>
                            ...
                            <td>
                                <p style="text-align:left;padding:10px;padding-bottom:0;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    Upcoming Sessions until Next <?php
                                                                    echo date("l", strtotime("+1 week"));
                                                                    ?>
                                </p>
                                <p style="padding-bottom:19px;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
